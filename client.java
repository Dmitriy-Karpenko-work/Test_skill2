...
public class client{
    public static void main(String[] args) {
        laptop lap1=new laptop("Modern15",1234,"MSI");
        lap1.setColor("black");
        lap1.setHDD(256);
        lap1.setOS("Windows");
        lap1.setRAM(8);
        
        laptop lap2=new laptop("VivoBook PRO 15",5678,"ASUS");
        lap2.setColor("white");
        lap2.setHDD(1024);
        lap2.setOS("Windows");
        lap2.setRAM(16);

        laptop lap3=new laptop("M543",7896,"Maibenben");
        lap3.setColor("silver");
        lap3.setHDD(512);
        lap3.setOS("Windows");
        lap3.setRAM(16);

        laptop lap4=new laptop("KataSna GF76",2222,"MSI");
        lap4.setColor("black");
        lap4.setHDD(512);
        lap4.setOS("Linux");
        lap4.setRAM(8);
